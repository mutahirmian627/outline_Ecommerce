...
import { currency } from "../components/config.js";
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="hidden md:grid grid-cols-[1fr_3fr_1fr_1fr_1fr] items-center py-1 px-2 border bg-gray-200 text-sm rounded">
          <b>Image</b>
          <b>Name</b>
          <b>Category</b>
          <b>Price</b>
